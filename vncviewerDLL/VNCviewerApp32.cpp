...
HWND VNCviewerApp32::NewConnection(bool Is_Listening) {
...
ClientConnection* VNCviewerApp32::NewConnection2(bool Is_Listening,TCHAR *host, int port) {
...
HWND VNCviewerApp32::NewConnection(bool Is_Listening,TCHAR *host, int port) {
	ClientConnection *pcc = new ClientConnection(this, host,port);
	try {
		memcpy((char*)&pcc->m_opts,(char*)&m_options,sizeof(m_options));
		pcc->m_Is_Listening=Is_Listening;
...
HWND VNCviewerApp32::NewConnection(bool Is_Listening,SOCKET sock) {
