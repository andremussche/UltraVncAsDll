...
public:
	...
	virtual HWND NewConnection(bool Is_Listening) = 0;
	virtual HWND NewConnection(bool Is_Listening,TCHAR *host, int port) = 0;
	virtual HWND NewConnection(bool Is_Listening,SOCKET sock) = 0;
